...
cdef class ProjRecorder0_wrapper:
    ...
    property c:
        def __get__(self): return (ProjRecorder0.get_instance(self.id)).c
        def __set__(self, val): (ProjRecorder0.get_instance(self.id)).c = val
    property record_c:
        def __get__(self): return (ProjRecorder0.get_instance(self.id)).record_c
        def __set__(self, val): (ProjRecorder0.get_instance(self.id)).record_c = val
    def clear_c(self):
        (ProjRecorder0.get_instance(self.id)).c.clear()

    property x:
        def __get__(self): return (ProjRecorder0.get_instance(self.id)).x
        def __set__(self, val): (ProjRecorder0.get_instance(self.id)).x = val
    property record_x:
        def __get__(self): return (ProjRecorder0.get_instance(self.id)).record_x
        def __set__(self, val): (ProjRecorder0.get_instance(self.id)).record_x = val
    def clear_x(self):
        (ProjRecorder0.get_instance(self.id)).x.clear()

    property y:
        def __get__(self): return (ProjRecorder0.get_instance(self.id)).y
        def __set__(self, val): (ProjRecorder0.get_instance(self.id)).y = val
    property record_y:
        def __get__(self): return (ProjRecorder0.get_instance(self.id)).record_y
        def __set__(self, val): (ProjRecorder0.get_instance(self.id)).record_y = val
    def clear_y(self):
        (ProjRecorder0.get_instance(self.id)).y.clear()
