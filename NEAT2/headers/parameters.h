...
class Parameters{
    public:
        ...
        Parameters(int numberGenomes, int numberInputs, int numberOutputs, 
            float keep=0.5, float threshold=0.4,
            float probabilityInterespecies=0.001, float probabilityNoCrossoverOff=0.25,
            float probabilityWeightMutated=0.8, 
            float probabilityAddNodeSmall=0.03, float probabilityAddLink_small=0.05,
            float probabilityAddNodeLarge=0.1, float probabilityAddLink_Large=0.2,
            int largeSize=20,
