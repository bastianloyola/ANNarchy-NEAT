...
def objetive(trial):
    ...
    update_function3 = BoundedRandomWalk(scheduler, mu=0, sigma=10, min_val=0.05, max_val=0.5)
    tunable_params = {"force_mag": update_function, "length": update_function2, "masspole": update_function3}
