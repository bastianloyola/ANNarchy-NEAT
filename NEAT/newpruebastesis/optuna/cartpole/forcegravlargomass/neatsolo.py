...
def objetive(trial):
    ...
    update_function2 = BoundedRandomWalk(scheduler, mu=0, sigma=10, min_val=0.5, max_val=0.75)
    update_function3 = BoundedRandomWalk(scheduler, mu=0, sigma=10, min_val=9.0, max_val=20.0)
    update_function4 = BoundedRandomWalk(scheduler, mu=0, sigma=10, min_val=0.05, max_val=0.5)
    tunable_params = {"force_mag": update_function, "length": update_function2, "gravity": update_function3, "masspole": update_function4}
