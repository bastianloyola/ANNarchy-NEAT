...
for trial in range(trials):
    ...
    tau_c = 25.56854608692525
    a_plus = 0.034314012447290425
    a_minus = 0.04755286848011282
    tau_plus = 25.702644223722626
    tau_minus = 25.313220177881593
...
print("Largos1", largos1)
print("Largos2", largos2)
print("Masas1", masas1)
print("Masas2", masas2)
print("MOI1", moi1)
print("MOI2", moi2)
...
plt.figure(figsize=(10, 5))
plt.plot(largos1, label='Largo 1', color='blue')
plt.plot(largos2, label='Largo 2', color='orange')
...
plt.figure(figsize=(10, 5))
plt.plot(masas1, label='Masa 1', color='blue')
plt.plot(masas2, label='Masa 2', color='orange')
...
plt.figure(figsize=(10, 5))
plt.plot(moi1, label='MOI 1', color='blue')
plt.plot(moi2, label='MOI 2', color='orange')
